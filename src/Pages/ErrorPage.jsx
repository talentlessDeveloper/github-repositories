...
function ErrorPage() {
  return (
    <section className='bg-neutral-50 text-zinc-700 dark:bg-zinc-700 dark:text-neutral-50'>
      <div className='repo-container flex flex-col justify-center items-center h-screen'>
        ...
        <p className='flex items-center text-center gap-x-2 mt-4'>
          <span className='text-xl'> No dey waka illegally,</span>{" "}
          <Link to='/' className='bg-yellow-400 text-lg block w-36  py-1'>
            Go Back Home
          </Link>
        </p>
      </div>
